...
class TruckSpecsForm extends StatefulWidget {
  const TruckSpecsForm({super.key});

  @override
  State<TruckSpecsForm> createState() => _TruckSpecsFormState();
}

class _TruckSpecsFormState extends State<TruckSpecsForm> {
